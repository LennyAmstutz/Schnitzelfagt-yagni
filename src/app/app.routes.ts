...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./camera-permission/camera-permission.page').then(
        (m) => m.CameraPermissionPage,
      ),
  },
  {
    path: 'geolocation-permission',
    loadComponent: () =>
      import('./geolocation-permission/geolocation-permission.page').then(
        (m) => m.GeolocationPermissionPage,
      ),
  },
];
